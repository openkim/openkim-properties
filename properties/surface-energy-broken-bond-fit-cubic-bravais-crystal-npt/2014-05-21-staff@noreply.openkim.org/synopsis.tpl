...
Fitting parameters and errors:
   ...
   c  = @< fit-c.source-value >@ @< fit-c.source-unit >@
   p1 = @< fit-p1.source-value >@ @< fit-p1.source-unit >@
   p2 = @< fit-p2.source-value >@ @< fit-p2.source-unit >@
   p3 = @< fit-p3.source-value >@ @< fit-p3.source-unit >@

   Maximum error = @< fit-error-max.source-value >@
   Error range   = @< fit-error-range.source-value >@
